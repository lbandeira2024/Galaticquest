...
// Se não tiver o arquivo config.json, comente a linha abaixo e ajuste o CORS manualmente
...
// ==================================================================
//  1. CONFIGURAÇÃO DO BANCO DE DADOS (JÁ COM SUA SENHA)
// ==================================================================
// Atenção: A senha @4Parodius foi convertida para %404Parodius por causa do caractere especial
const MONGO_URI = "mongodb+srv://lbandeira_db_user:%404Parodius@galacticquest.xi2giit.mongodb.net/galacticquest?retryWrites=true&w=majority";
...
app.use(cors({
  origin: config.frontendUrl, // Certifique-se que o config.json tem essa URL
  credentials: true
}));
...
// ==================================================================
//  CONEXÃO COM O MONGODB (MODIFICADA)
// ==================================================================
mongoose.connect(MONGO_URI, {
  useNewUrlParser: true,
  useUnifiedTopology: true,
}).then(() => console.log("✅ Conectado ao MongoDB (GalacticQuest)"))
...
// Use a variável de ambiente PORT se existir (Render), senão use a do config ou 5000
const PORT = process.env.PORT || (config && config.serverPort) || 5000;
